...
yyc_RAW:
	...
	yych = *YYCURSOR;
	YYDEBUG(111, yych);
	if (yybm_RAW[0+yych] & 8) goto yy113;
	if (yych <= '\n') goto yy112;
	if (yych <= '"') goto yy115;
	if (yych <= '#') goto yy117;
	if (yych <= '\'') goto yy118;
...
yy115:
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_RAW[0+yych] & 32) goto yy120;
	if (yych >= '#') goto yy121;
yy116:
	YYDEBUG(116, yych);
	YYCURSOR = YYMARKER;
...
yy118:
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_RAW[0+yych] & 64) goto yy122;
	if (yych <= '\'') goto yy116;
	goto yy123;
yy119:
	YYDEBUG(119, yych);
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_RAW[0+yych] & 16) goto yy119;
	if (yych <= '!') {
...
yy128:
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_RAW[0+yych] & 128) goto yy132;
	if (yych <= '\n') goto yy116;
	if (yych <= '"') goto yy127;
	if (yych <= '\'') goto yy120;
	goto yy133;
...
yy141:
	YYDEBUG(141, yych);
	yych = *++YYCURSOR;
	if (yybm_INITIAL[0+yych] & 128) goto yy142;
	goto yy140;
yy142:
	YYDEBUG(142, yych);
	++YYCURSOR;
