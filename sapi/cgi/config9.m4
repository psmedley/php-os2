...
if test "$PHP_CGI" != "no"; then
    ...
    case $host_alias in
      ...
      *darwin*)
      ...
      ;;
      *os2*)
        BUILD_CGI="\$(LIBTOOL) --mode=link \$(CC) -export-dynamic \$(CFLAGS_CLEAN) \$(EXTRA_CFLAGS) \$(EXTRA_LDFLAGS_PROGRAM) \$(LDFLAGS) \$(PHP_RPATHS) \$(PHP_FASTCGI_OBJS) \$(PHP_CGI_OBJS) \$(EXTRA_LIBS) \$(ZEND_EXTRA_LIBS) -Zomf -Zmap -Zhigh-mem -Zstack 8000 libphp.la  -o \$(SAPI_CGI_PATH)"
      ;;
      *)
