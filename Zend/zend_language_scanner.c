...
yyc_ST_IN_SCRIPTING:
	...
	yych = *YYCURSOR;
	YYDEBUG(0, yych);
	if (yybm_ST_IN_SCRIPTING[0+yych] & 2) goto yy2;
	switch (yych) {
		case 0x00:
		case 0x01:
		case 0x02:
...
yy25:
	YYDEBUG(25, yych);
	if (yybm_ST_IN_SCRIPTING[0+yych] & 4) goto yy24;
	if (yych <= 'E') {
		if (yych == '.') goto yy103;
		if (yych <= 'D') goto yy23;
		goto yy105;
...
yy40:
	YYDEBUG(40, yych);
	if (yybm_ST_IN_SCRIPTING[0+yych] & 8) goto yy39;
	if (yych == '\\') goto yy127;
	goto yy32;
yy41:
	YYDEBUG(41, yych);
		...
		if (yyaccept <= 23) {
			...
			if (yyaccept <= 35) {
				...
				if (yyaccept <= 41) {
					...
					if (yyaccept <= 44) {
						if (yyaccept <= 43) {
							if (yyaccept == 42) goto yy424;
							else goto yy426;
						} else {
							goto yy429;
						}
					} else {
						if (yyaccept == 45) goto yy439;
						else goto yy441;
					}
				}
			}
		...
		if (yyaccept <= 69) {
			if (yyaccept <= 58) {
				...
				if (yyaccept <= 64) {
					...
					if (yyaccept <= 67) {
						if (yyaccept <= 66) {
							if (yyaccept == 65) goto yy559;
							else goto yy563;
						} else {
							goto yy574;
						}
					} else {
						if (yyaccept == 68) goto yy576;
						else goto yy578;
					}
				}
			}
			...
			if (yyaccept <= 81) {
				...
				if (yyaccept <= 87) {
					...
					if (yyaccept <= 90) {
						if (yyaccept <= 89) {
							if (yyaccept == 88) goto yy670;
							else goto yy672;
						} else {
							goto yy674;
						}
					} else {
						if (yyaccept == 91) goto yy680;
						else goto yy683;
					}
				}
			}
...
yy77:
	YYDEBUG(77, yych);
	if (yybm_ST_IN_SCRIPTING[0+yych] & 16) goto yy76;
	switch (yych) {
		case 'A':
		case 'a': goto yy78;
		case 'B':
...
yy104:
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_ST_IN_SCRIPTING[0+yych] & 32) goto yy196;
	goto yy71;
yy105:
	YYDEBUG(105, yych);
	yych = *++YYCURSOR;
...
yy106:
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_ST_IN_SCRIPTING[0+yych] & 64) goto yy200;
	goto yy71;
yy107:
	YYDEBUG(107, yych);
	++YYCURSOR;
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_ST_IN_SCRIPTING[0+yych] & 128) goto yy202;
	goto yy71;
yy108:
	YYDEBUG(108, yych);
	++YYCURSOR;
...
yyc_ST_LOOKING_FOR_PROPERTY:
	...
	yych = *YYCURSOR;
	YYDEBUG(684, yych);
	if (yybm_ST_LOOKING_FOR_PROPERTY[0+yych] & 64) goto yy686;
	if (yych <= 'Z') {
		if (yych <= '>') {
			if (yych == '-') goto yy687;
		} else {
...
yy689:
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_ST_LOOKING_FOR_PROPERTY[0+yych] & 128) goto yy689;
	yyleng = YYCURSOR - SCNG(yy_text);
	{
	yy_pop_state();
	RETURN_TOKEN_WITH_STR(T_STRING, 0);
...
yy698:
	...
	YYFILL(4);
	yych = *YYCURSOR;
	if (yybm_ST_BACKQUOTE[0+yych] & 128) goto yy698;
	if (yych <= '>') {
		if (yych == '-') goto yy702;
	} else {
		if (yych <= '?') goto yy704;
...
yy716:
	...
	YYFILL(4);
	yych = *YYCURSOR;
	if (yybm_ST_DOUBLE_QUOTES[0+yych] & 128) goto yy716;
	if (yych <= '>') {
		if (yych == '-') goto yy720;
	} else {
		if (yych <= '?') goto yy722;
...
yy733:
	...
	YYFILL(4);
	yych = *YYCURSOR;
	if (yybm_ST_HEREDOC[0+yych] & 128) goto yy733;
	if (yych <= '>') {
		if (yych == '-') goto yy737;
	} else {
		if (yych <= '?') goto yy739;
...
yy751:
	YYDEBUG(751, yych);
	if (yybm_ST_LOOKING_FOR_VARNAME[0+yych] & 128) goto yy750;
	if (yych <= '@') goto yy752;
	if (yych <= '[') goto yy753;
	if (yych == '}') goto yy753;
yy752:
...
yy762:
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_ST_VAR_OFFSET[0+yych] & 8) goto yy762;
	if (yych == '_') goto yy773;
	goto yy761;
yy763:
	YYDEBUG(763, yych);
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_ST_VAR_OFFSET[0+yych] & 16) goto yy763;
	yyleng = YYCURSOR - SCNG(yy_text);
	{
	RETURN_TOKEN_WITH_STR(T_STRING, 0);
}
...
yy769:
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_ST_VAR_OFFSET[0+yych] & 32) goto yy774;
yy770:
	YYDEBUG(770, yych);
	YYCURSOR = YYMARKER;
	if (yyaccept == 0) goto yy761;
	else goto yy768;
yy771:
	YYDEBUG(771, yych);
	++YYCURSOR;
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_ST_VAR_OFFSET[0+yych] & 64) goto yy775;
	goto yy770;
yy772:
	YYDEBUG(772, yych);
	++YYCURSOR;
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_ST_VAR_OFFSET[0+yych] & 128) goto yy776;
	goto yy770;
yy773:
	YYDEBUG(773, yych);
	++YYCURSOR;
...
yy780:
	...
	YYFILL(1);
	yych = *YYCURSOR;
	if (yybm_SHEBANG[0+yych] & 128) goto yy780;
	++YYCURSOR;
	yyleng = YYCURSOR - SCNG(yy_text);
	{
	CG(zend_lineno)++;
